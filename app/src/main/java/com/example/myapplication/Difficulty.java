...
public enum Difficulty {
    ...
    private final int optimalTime; // оптимальное время в секундах
    private final double pathLengthPercentage; // процент длины пути
    ...
    // Новый метод для корректировки количества компонентов
